...
export function GitHubLogo({ className }: HeroIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function LinkedInLogo({ className }: HeroIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function HelloWaveIcon({ className }: HeroIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 256 256"
...
export function GamepadIcon({ className }: HeroIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function PhoneIcon({ className }: HeroIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
